    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = if (surveyUUID != null) "تعديل مسح بئر مياه" else "مسح بئر مياه جديد",
        ...
        if (uiState.saveSuccess || uiState.draftSaveSuccess) {
            val successText = if (uiState.draftSaveSuccess) "تم حفظ مسودة البئر بنجاح!" else "تم حفظ مسح البئر بنجاح!"
            Box(
                ...
                Card(
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text("نوع البئر (ارتوازي، يدوي...)") },
                            modifier = Modifier.fillMaxWidth(),
                            colors = OutlinedTextFieldDefaults.colors(
                                focusedBorderColor = Emerald500,
                                unfocusedBorderColor = Slate700,
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text("عمق البئر التقريبي (متر)") },
                            modifier = Modifier.fillMaxWidth(),
                            colors = OutlinedTextFieldDefaults.colors(
                                focusedBorderColor = Emerald500,
                                unfocusedBorderColor = Slate700,
